...
import '../providers/hive_viewmodel.dart';
...
class _HiveDemoViewState extends State<HiveDemoView> {
  ...
  Widget _buildTerminalConsole(HiveViewModel viewModel, ColorScheme colorScheme) {
    return Card(
      elevation: 4,
                    ...
                    onPressed: () {
                      ...
                      if (key.isEmpty || val.isEmpty) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('⚠️ Key and Value fields cannot be empty!')),
                        );
                        return;
                      }
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          ...
                          subtitle: Text(
                            'Value: "$val"',
                            style: TextStyle(fontFamily: 'monospace', color: Colors.orange.shade900),
                          ),
                          trailing: IconButton(
  ...
  Widget _buildCustomObjectCard(HiveViewModel viewModel, ColorScheme colorScheme) {
    return Card(
      elevation: 2,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)),
      child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Icon(
                        _editingUser != null ? Icons.edit_note : Icons.add_circle_outline,
                        color: Colors.orange.shade900,
                        size: 18,
                      ),
                      const SizedBox(width: 6),
                      Text(
                        _editingUser != null ? 'Edit Stored User' : 'Register New User Object',
                        style: TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.bold,
                          color: Colors.orange.shade900,
                        ...
                        child: ElevatedButton.icon(
                          ...
                          onPressed: () {
                            ...
                            if (name.isEmpty || email.isEmpty) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(content: Text('⚠️ Name and Email are mandatory fields!')),
                              );
                              return;
                            }
                          ...
                          icon: Icon(_editingUser != null ? Icons.done : Icons.person_add, size: 16),
                          label: Text(_editingUser != null ? 'Update Record' : 'Save User Object'),
                        ),
                      ),
                            ...
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content: Text('✍️ User loaded into form. Modify values and tap Update.'),
